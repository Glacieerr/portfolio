...
export async function GET(request) {
  try {
    ...
    const mediaFolder = process.env.MEDIA_FOLDER || "images/works";

    const apiUrl = `https://api.github.com/repos/${owner}/${repo}/contents/${mediaFolder}`;
    ...
    if (!response.ok) {
      ...
      return json({
        ok: false,
        error: "Failed to list media folder from GitHub.",
        detail
      }, response.status);
    }
